...
import com.esaudev.tracker_domain.model.MealType
...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val userInformation = preferences.loadUserPreferences()

        val calorieGoal = dailyCalorieRequirement(userInformation)
        val carbsGoal = (calorieGoal * userInformation.carbRatio / 4f).roundToInt()
        val proteinGoal = (calorieGoal * userInformation.proteinRatio  / 4f).roundToInt()
        val fatGoal = (calorieGoal * userInformation.fatRatio / 9f).roundToInt()
    ...
    private fun bmr(userInfo: UserPreferences): Int {
    ...
    private fun dailyCalorieRequirement(userInfo: UserPreferences): Int {
